<template>
  <main class="h-screen flex flex-col justify-center items-center bg-purple-200 relative overflow-hidden">
    <main class="flex w-full flex-col items-center justify-center text-center px-4">
      ...
      <h1 class="mx-auto max-w-4xl font-display text-5xl font-bold tracking-normal text-slate-900 sm:text-7xl">MXN On The <span class="text-purple-600" id="text-change">Go</span></h1>
      ...
      <a class="bg-black rounded-xl text-white font-medium px-4 py-3 sm:mt-10 mt-8 transition duration-300 hover:opacity-80" href="#">Explore →</a>
    </main>
  </main>
</template>
...
export default {
  mounted() {
    ...
    const texts = ['Go', 'USD', 'EUR']; // Add your desired texts here
