<template>
    <div class="mx-auto bg-purple-200 w-full max-w-container px-4 sm:px-6 lg:px-8">
        <div class="border-t border-slate-900/5 py-10">
            <div class="flex justify-center">
                <img class="w-32" src="https://media.discordapp.net/attachments/1208411877198266379/1208412055883878421/MXN-removebg-preview.png?ex=65ec6aed&is=65d9f5ed&hm=7c61637338b887d278b5489269f30c14422fbbf9446a4ab87e80425891dbca7a&=&format=webp&quality=lossless" alt="">
            </div>
            <p class="mt-5 text-center text-sm leading-6 text-slate-500">© 2024 MXN Lab. All rights reserved.</p>
